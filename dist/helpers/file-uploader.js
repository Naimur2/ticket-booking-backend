...
const uploadFile = (maxFileSize, _allowedFileTypes, folderPath, errorMessage) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (0, multer_1.default)({
        ...
        fileFilter(req, file, callback) {
            if (_allowedFileTypes.includes(file.mimetype)) {
                ...
                callback((0, http_errors_1.default)(errorMessage));
            }
        },
    });
});
